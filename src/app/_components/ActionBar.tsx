...
export default function ActionBar() {
  return (
    <div className="fixed bottom-0 left-0 right-0 flex flex-col justify-center gap-x-5 gap-y-2 p-4 sm:flex-row">
      ...
      <button
        onClick={() => NiceModal.show(AddExpenseModal)}
        className="flex items-center justify-center gap-1 rounded-xl bg-blue-500 px-4 py-2 font-semibold text-white transition-colors hover:bg-blue-600"
      >
